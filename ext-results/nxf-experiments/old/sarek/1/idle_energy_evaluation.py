...
energy_unit_joules = 1e-6  # 1 µJ converted to joules
...
energy_consumed_node37 = energy_consumed_rapl1 + energy_consumed_DRAM1
energy_consumed_node38 = energy_consumed_rapl2 + energy_consumed_DRAM2
energy_consumed_cpu = energy_consumed_rapl1 + energy_consumed_rapl2
energy_consumed_dram = energy_consumed_DRAM1 + energy_consumed_DRAM2
energy_consumed_total = energy_consumed_rapl1 + energy_consumed_rapl2 + energy_consumed_DRAM1 + energy_consumed_DRAM2

print(f"Node 37 CPU: {energy_consumed_rapl1:.2f} Joules")
print(f"Node 38 CPU: {energy_consumed_rapl2:.2f} Joules")
print(f"Node 37 DRAM: {energy_consumed_DRAM1:.2f} Joules")
print(f"Node 38 DRAM: {energy_consumed_DRAM2:.2f} Joules")
print(f"Energy Node 37: {energy_consumed_node37:.2f} Joules")
print(f"Energy Node 38: {energy_consumed_node38:.2f} Joules")
print(f"Energy CPU: {energy_consumed_cpu:.2f} Joules")
print(f"Energy DRAM: {energy_consumed_dram:.2f} Joules")
print(f"Total energy consumed: {energy_consumed_total:.2f} Joules")

summary_lines = [
    f"Node 37 CPU: {energy_consumed_rapl1:.2f} Joules",
    f"Node 38 CPU: {energy_consumed_rapl2:.2f} Joules",
    f"Node 37 DRAM: {energy_consumed_DRAM1:.2f} Joules",
    f"Node 38 DRAM: {energy_consumed_DRAM2:.2f} Joules",
    f"Energy Node 37: {energy_consumed_node37:.2f} Joules",
    f"Energy Node 38: {energy_consumed_node38:.2f} Joules",
    f"Energy CPU: {energy_consumed_cpu:.2f} Joules",
    f"Energy DRAM: {energy_consumed_dram:.2f} Joules",
    f"**Total energy consumed:** {energy_consumed_total:.2f} Joules",
]
md = "# Idle run summary\n\n" + "\n".join(f"- {s}" for s in summary_lines)

with open("idle_data.md", "w") as f:
    f.write(md)
